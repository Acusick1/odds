...
def info():
    ...
    table.add_row("Dry-Run Mode", "Enabled" if settings.scheduler_dry_run else "Disabled")
...
def list_jobs():
    ...
    try:
        ...
        console.print(
            f"\n[dim]Backend {settings.scheduler_backend} does not support job listing[/dim]"
        )
